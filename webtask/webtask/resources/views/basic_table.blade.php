...
<head>
  ...
  <link rel="stylesheet" href="data/template/vendors/css/vendor.bundle.addons.css')}}"
  <!-- endinject -->
  <!-- inject:css -->
...
<body>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="{{asset('data/template/images/faces/face4.jpg')}}" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="{{asset('data/template/images/faces/face2.jpg')}}" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                    <img src="{{asset('data/template/images/faces/face3.jpg')}}" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{asset('data/template/images/faces/face5.jpg')}}" alt="profile"/>
            </a>
        ...
        <div class="tab-content" id="setting-content">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('data/template/images/faces/face3.jpg')}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('data/template/images/faces/face4.jpg')}}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('data/template/images/faces/face5.jpg')}}" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{asset('data/template/images/faces/face6.jpg')}}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
              <td class="py-1">{{$key->basic_name}}</td>
                          <td> {{$key->basic_email}}</td>
                          <td> {{$key->basic_password}} </td>
                          <td> {{$key->basic_occupation}}</td>
                          <td> {{$key->basic_phone_no}}</td>
                          <td>{{$key->basic_education}}</td>
                          <td><a href="dataedit/{{$key->basic_id}}">Edit</a></td>
                          <td><a href="datadelete/{{$key->basic_id}}">Delete</a></td>
                        </tr>
                      @endforeach
                      </tbody>
                    </table>
  ...
  <script src="data/template/vendors/js/vendor.bundle.addons.js')}}"></script>
  <!-- endinject -->
