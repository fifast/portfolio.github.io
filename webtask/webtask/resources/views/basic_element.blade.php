...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="data/template/index-2.html"><img src="data/template/images/logo.svg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="data/template/index-2.html"><img src="data/template/images/logo-mini.svg" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="data/template/images/faces/face1.jpg" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="data/template/images/faces/face2.jpg" alt="image"><span class="offline"></span></div>
                <div class="info">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="data/template/index-2.html">
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="data/template/vendors/js/vendor.bundle.base.js"></script>
  <script src="data/template/vendors/js/vendor.bundle.addons.js"></script>
  <!-- endinject -->
  <!-- inject:js -->
  <script src="data/template/js/off-canvas.js"></script>
  <script src="data/template/js/hoverable-collapse.js"></script>
  <script src="data/template/js/misc.js"></script>
  <script src="data/template/js/settings.js"></script>
  <script src="data/template/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="data/template/js/file-upload.js"></script>
  <script src="data/template/js/typeahead.js"></script>
  <script src="data/template/js/select2.js"></script>
